  ...
  return (
    <>
      ...
      >
        <div className="relative w-64 h-80 bg-gradient-to-br from-marigold-sun via-haldi to-marigold-sun rounded-[50%] p-2 shadow-2xl 
          ...
          <div className="relative w-full h-full bg-gradient-to-br from-pearl-petal to-gulabi-50 rounded-[50%] overflow-hidden
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full p-6">
              ...
              <h3 className="text-xl font-bold text-rani-glow mb-2" style={{ fontFamily: 'var(--font-playfair)' }}>
                {label}
              </h3>
        ...
        <motion.div
          className="absolute -top-2 -right-2 text-marigold-sun text-sm"
        ...
        {isOpen && (
          ...
          >
            <motion.div
              ...
              className="relative bg-pearl-petal rounded-3xl p-8 max-w-md w-full shadow-2xl border-4 border-coquette-pink"
            >
              ...
              <button
                ...
                className="absolute top-4 right-4 w-8 h-8 rounded-full bg-gulabi-200 
                         ...
                         text-rani-glow font-bold cursor-pointer"
              >
                x
              </button>
              ...
              <h3 className="text-2xl font-bold text-center text-rani-glow mb-2" style={{ fontFamily: 'var(--font-playfair)' }}>
                {label}
              </h3>
